package com.nao20010128nao.Fiendish.level;
...
/**
 * This class is to raise unpreventable explosion<br>
 * Source: https://github.com/Nukkit/Nukkit/blob/master/src/main/java/cn/nukkit/level/Explosion.java
 */
public class UnpreventableExplosion {
    ...
    public UnpreventableExplosion(Position center, double size) {
    ...
    public boolean explodeB() {
        ...
        Entity[] list = this.level.getNearbyEntities(explosionBB, null);
